...
export const metadata: Metadata = {
  ...
  description:
    "Pixxelpulse started as one freelance editor in 2018 and grew into a full post-production team. Meet the people behind 1,300+ delivered videos.",
  ...
  return (
    <div className="relative overflow-x-clip">
      ...
      <header className="relative mx-auto max-w-[1440px] px-6 pt-[calc(var(--nav-h)+3.5rem)] lg:px-12 lg:pt-[calc(var(--nav-h)+5.5rem)]">
        <SectionHeading
          as="h1"
          eyebrow="About Pixxelpulse"
          heading={
            <>
              Built in the edit, <span className="text-gradient">one frame at a time.</span>
            </>
          }
          lead="Pixxelpulse started in December 2018 as one freelance editor taking on projects nobody else wanted to rush. Seven years and 1,300+ videos later, it's a full post-production team trusted by creators, startups, and brands across 40+ industries."
        />
      </header>
      ...
      <section className="mx-auto max-w-[1440px] px-6 py-24 lg:px-12 lg:py-36">
        <div className="grid gap-14 lg:grid-cols-2 lg:gap-24">
          ...
          <div className="space-y-6">
            ...
            <Reveal delay={200}>
              <p className="text-lead">
                Today Pixxelpulse runs as an editor-led studio: every project has a dedicated
