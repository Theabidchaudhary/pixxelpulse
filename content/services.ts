...
export const services: Service[] = [
  {
    ...
    seo: {
      ...
      description:
        "Premium short-form video editing for creators and brands. Hook-first Reels, TikToks, and Shorts with kinetic captions, delivered in 48–72 hours by Pixxelpulse.",
    },
  },
  {
    ...
    seo: {
      ...
      description:
        "YouTube and long-form video editing engineered for retention. Full episode edits, documentary post-production, and weekly publishing pipelines by Pixxelpulse.",
    },
  },
  {
    ...
    seo: {
      ...
      description:
        "Motion design studio for brands and creators: logo animation, intros, lower thirds, explainer animation, and VFX. Build a motion identity with Pixxelpulse.",
    },
  },
  {
    ...
    seo: {
      ...
      description:
        "Performance video creative for paid social: UGC-style ads, A/B variant packs, and platform-ratio exports delivered in 48–72 hours by Pixxelpulse.",
    },
  },
  {
    ...
    seo: {
      ...
      description:
        "Podcast post-production that turns one recording into a week of content: full episode edits, 10+ vertical clips, and audiograms. By Pixxelpulse.",
    },
  },
  {
    ...
    heroSub:
      "Marketing agencies, production studios, and design teams plug Pixxelpulse in as invisible editing capacity — NDA-first, SLA-backed, delivered under your brand.",
    pain: {
    ...
    seo: {
      ...
      description:
        "White-label video editing and motion design capacity for agencies: dedicated editor pods, NDA-first workflows, and SLA-backed turnaround from Pixxelpulse.",
    },
  },
];
