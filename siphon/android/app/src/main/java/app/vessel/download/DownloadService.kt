...
import app.vessel.data.db.DownloadStatus
...
class DownloadService : Service() {
    ...
    companion object {
        private const val ACTION_KICK = "app.vessel.action.KICK"
        private const val ACTION_PAUSE = "app.vessel.action.PAUSE"
        private const val ACTION_CANCEL = "app.vessel.action.CANCEL"
